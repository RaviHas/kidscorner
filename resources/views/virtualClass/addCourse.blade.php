    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                {!! Form::open(array('url'=>'addcourse','method'=>'POST')) !!}
                    ...
                    <table>
                        <tr>
                            ...
                            <td> {!! Form::select('grade', array('Select One' => 'Select One', '2' => '2', '3' => '3', '4' => '4'), $grade,
                               ['class' => 'form-control','id' => 'grade','style' => "width:220px", 'onchang'=>"window.location.href = '/coursedrop/'+document.getElementById('grade').value +'/'+document.getElementById('subject').value "])!!}</td>
                        ...
                        <tr>
                            ...
                            <td>{!! Form::select('colour', array('' => 'Select One', '#DC143C' => 'Crimson', '#8A2BE2' => 'BlueViolet',
