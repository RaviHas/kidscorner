        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            @foreach($upldtbls as $uplds)
                ...
                <tr class="success">
                    ...
                    <td align="left">{{$uplds->title}}</td>
                    <td align="left" style="width: 85px"><a href="/{{$surl}}">Open</a> |
                        <a href="/hgh1/{{$uplds->id}}/{{$uplds->subject}}/{{$uplds->grade}}/{{$fileName}}/{{$uplds->title}}">Edit</a>|
                        <a href="/hgh/{{$uplds->id}}"
                           onclick="
                                if( ! confirm('Are you sure you want to delete?')){return false;}">Delete</a>
