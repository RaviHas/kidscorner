...
<body>
  ...
  <div class="container">
      <h2 class="title-box_primary">Our Courses</h2>
      <div class="row">
          <div class="col-md-3">
              <div class="grey-box-icon b1">
                  ...
                  <p><a href="parent/2"><em>Go →</em></a></p>
              </div><!--grey box -->
          </div><!--/span3-->
          <div class="col-md-3">
              <div class="grey-box-icon b2">
                  ...
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent tempus eleifend risus ut congue
                      eset nec lacus elit dor broma.</p>
                  <p><a href="parent/3"><em>Go →</em></a></p>
              </div><!--grey box -->
          </div><!--/span3-->
          <div class="col-md-3">
              <div class="grey-box-icon b3">
                  ...
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent tempus eleifend risus ut congue
                      eset nec lacus elit dor broma.</p>
                  <p><a href="parent/4"><em>Go →</em></a></p>
              </div><!--grey box -->
          </div><!--/span3-->
          <div class="col-md-3">
      ...
      <div class="row">
         ...
         <a href="/vcalendar"><div class="col-md-4"><div class="title-box clearfix "><h2 class="title-box_primary">Events Calender</h2></div>
          ...
          <a href="/select">
              <div class="col-md-8"><div class="title-box clearfix "><h2 class="title-box_primary">View Course Materials</h2></div>
          </a>
      </section>
