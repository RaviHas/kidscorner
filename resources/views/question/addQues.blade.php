...
@section('content')
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-default">
            ...
            <!--add new question-->
            {!! Form::open(array('url'=>'addquestion','method'=>'POST', 'files'=>true)) !!}

            <div class="form-group">
            <table>
                <tr>
                    <td style="width: 200px"><label for="Grade" style="margin-bottom: 20px">Grade</label></td>
                    <td style="width: 200px">{!! Form::text('grade', $grade ,['class'=>'form-control','readonly' => 'true']) !!}</td>
                </tr>
                <tr>
                    <td style="width: 200px"><label for="Subject" style="margin-bottom: 20px">Subject</label></td>
                    <td style="width: 200px">{!! Form::text('subject', $subject ,['class'=>'form-control','readonly' => 'true']) !!}</td>
                </tr>
            </table>
            </div>
            ...
            <table>
               <tr>
                   ...
                   <td style="width: 300px">{!! Form::select('title', $categories, null, ['class' => 'form-control'] )!!}</td>
               </tr>
               <tr>
                   <td></td>
                   <td style="width: 200px"><a href="/addtitle/{{$grade}}/{{$subject}}">Add New Title</a> </td>
               </tr>
                @if($errors->has('title'))
                    <tr><td></td>
            ...
            <div class="form-group">
                <table>
                    <tr>
                        ...
                        <td style="width: 200px">{!! Form::select('questiontype', array('' => 'Select One', 'questiontext' => 'Text Question', 'questionimage' => 'Image Question', 'both' => 'Both'), '',
            ...
            <div class="form-group">
                <table>
                    ...
                    <tr>
                        ...
                        <td style="width: 200px">{!! Form::select('canswer', array('' => 'Select One', '1' => 'Answer 1', '2' => 'Answer 2', '3' => 'Answer 3', '4' => 'Answer 4'), '',
                                ['class' => 'form-control',])!!}</td>
                    </tr>
            ...
            <div class="form-group">
                <div class="col-md-6 col-md-offset-5">
                    <button type="submit" class="btn btn-primary" style="width: 200px">Add Question </button>
                </div>
            </div>
